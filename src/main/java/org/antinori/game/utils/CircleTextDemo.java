...
public class CircleTextDemo extends Canvas {
	 ...
	 * 
	 * @param ff
	 *            Font family (usually "Serif")
	 * @param fs
	 *            Font style (usually Font.PLAIN)
	 * @param fz
	 *            Font size (usually 18)
	 * @param bg
	 *            Background color for this canvas (usually pink)
	 * @param fg
	 *            Foreground color for text (usually black)
	 */
	 ...
	 * 
	 * @param g
	 *            - a Graphics, hopefully a Graphics2D
	 */
