...
public class SpinToWinDialog extends javax.swing.JDialog {
	...
	private void OkButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (jCheckBox9.isSelected()) count ++;
		if (jCheckBox10.isSelected()) count ++;
		...
		if (useSTW2CheckBox.isSelected() || useSTW4CheckBox.isSelected()) {
	    	selection.clear();
			if (jCheckBox1.isSelected()) selection.add(1);
			if (jCheckBox2.isSelected()) selection.add(2);
			if (jCheckBox3.isSelected()) selection.add(3);
			if (jCheckBox4.isSelected()) selection.add(4);
			if (jCheckBox5.isSelected()) selection.add(5);
			if (jCheckBox6.isSelected()) selection.add(6);
			if (jCheckBox7.isSelected()) selection.add(7);
			if (jCheckBox8.isSelected()) selection.add(8);
			if (jCheckBox9.isSelected()) selection.add(9);
			if (jCheckBox10.isSelected()) selection.add(10);
