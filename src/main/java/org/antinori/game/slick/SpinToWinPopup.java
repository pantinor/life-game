...
public class SpinToWinPopup {
    ...
    private void OkButtonActionPerformed() {
        ...
        int count = 0;
        if (jCheckBox1.isActive()) {
            count++;
        }
        if (jCheckBox2.isActive()) {
            count++;
        }
        if (jCheckBox3.isActive()) {
            count++;
        }
        if (jCheckBox4.isActive()) {
            count++;
        }
        if (jCheckBox5.isActive()) {
            count++;
        }
        if (jCheckBox6.isActive()) {
            count++;
        }
        if (jCheckBox7.isActive()) {
            count++;
        }
        if (jCheckBox8.isActive()) {
            count++;
        }
        if (jCheckBox9.isActive()) {
            count++;
        }
        if (jCheckBox10.isActive()) {
            count++;
        }
