...
public abstract class Entity implements Comparable<Entity> {
    ...
    public Entity(int tileX, int tileY) {
        ...
        this.x = tileX * LifeWorld.TILE_SIZE;
        this.y = tileY * LifeWorld.TILE_SIZE;
    ...
    public void setCurrentTile(int tileX, int tileY) {
        currentTileX = tileX;
        currentTileY = tileY;
        x = tileX * LifeWorld.TILE_SIZE;
        y = tileY * LifeWorld.TILE_SIZE;
    }
     ...
     * vertically.
     */
    public void addFlippedAnimation(String animName, boolean loop, boolean fliphorizontal, boolean flipvertical, int row, int... frames) {
        Animation anim = new Animation(false);
        anim.setLooping(loop);
        for (int frame : frames) {
    ...
    public Entity collide(String type, float x, float y) {
        ...
        for (Entity entity : world.getEntities()) {
            if (entity.collidable && entity.isType(type)) {
                if (!entity.equals(this) && x + hitboxOffsetX + hitboxWidth > entity.x + entity.hitboxOffsetX && y + hitboxOffsetY + hitboxHeight > entity.y + entity.hitboxOffsetY
                        && x + hitboxOffsetX < entity.x + entity.hitboxOffsetX + entity.hitboxWidth && y + hitboxOffsetY < entity.y + entity.hitboxOffsetY + entity.hitboxHeight) {
    ...
    public Entity collideWith(Entity other, float x, float y) {
        if (other.collidable) {
            if (!other.equals(this) && x + hitboxOffsetX + hitboxWidth > other.x + other.hitboxOffsetX && y + hitboxOffsetY + hitboxHeight > other.y + other.hitboxOffsetY && x + hitboxOffsetX < other.x + other.hitboxOffsetX + other.hitboxWidth
    ...
    public boolean collidePoint(float x, float y) {
        if (x >= this.x - hitboxOffsetX && y >= this.y - hitboxOffsetY && x < this.x - hitboxOffsetX + width && y < this.y - hitboxOffsetY + height) {
